...
const PBS_StencilMaterialSpecular: FC<PBS_StencilMaterialSpecularInput> = (
  props: PBS_StencilMaterialSpecularInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_StencilMaterialSpecular"
      id={id}
...
export default PBS_StencilMaterialSpecular;
