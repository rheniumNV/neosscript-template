...
export interface CrossMeshInput {
  id?: string;
  persistentId?: string;
  ...
  Size?: member<number>;
  BarRatio?: member<number>;
}

const CrossMesh: FC<CrossMeshInput> = (props: CrossMeshInput) => {
  const {
    id,
    persistentId,
    updateOrderId,
  ...
  return (
    ...
    >
      ...
      <Member
        type={`FrooxEngine.Sync\`1[System.Single]`}
        name="BarRatio"
        content={BarRatio} /* default: 0 */
      />
    </component>
  );
};

export default CrossMesh;
