...
export interface LinearColorMapperInput {
  id?: string;
  persistentId?: string;
...
const LinearColorMapper: FC<LinearColorMapperInput> = (
  props: LinearColorMapperInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.LinearColorMapper"
      id={id}
...
export default LinearColorMapper;
