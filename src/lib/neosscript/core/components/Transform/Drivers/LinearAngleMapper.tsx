...
export interface LinearAngleMapperInput {
  id?: string;
  persistentId?: string;
...
const LinearAngleMapper: FC<LinearAngleMapperInput> = (
  props: LinearAngleMapperInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.LinearAngleMapper"
      id={id}
    ...
    >
      ...
      <Member
        ...
        name="TargetMin"
        content={TargetMin} /* default: [0; 0; 0] */
      />
      <Member
        type={`FrooxEngine.Sync\`1[BaseX.float3]`}
        name="TargetMax"
        content={TargetMax} /* default: [0; 0; 0] */
      />
      <Member
        type={`FrooxEngine.Sync\`1[System.Boolean]`}
...
export default LinearAngleMapper;
