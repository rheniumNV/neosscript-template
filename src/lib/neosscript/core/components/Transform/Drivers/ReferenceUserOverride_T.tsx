...
const ReferenceUserOverride_T: FC<ReferenceUserOverride_TInput> = (
  props: ReferenceUserOverride_TInput
) => {
  const {
    type: {
      T: { name: T },
  ...
  return (
    <component
      name={`FrooxEngine.ReferenceUserOverride\`1[${[T]}]`}
      id={id}
...
export default ReferenceUserOverride_T;
