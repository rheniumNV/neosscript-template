...
export interface AttachMeshInput {
  id?: string;
  persistentId?: string;
...
const AttachMesh: FC<AttachMeshInput> = (props: AttachMeshInput) => {
  const {
    id,
    persistentId,
    updateOrderId,
  ...
  return (
    <component
      name="FrooxEngine.LogiX.Assets.AttachMesh"
      id={id}
