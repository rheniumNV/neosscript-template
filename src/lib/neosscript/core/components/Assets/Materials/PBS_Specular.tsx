...
export interface PBS_SpecularInput {
  id?: string;
  persistentId?: string;
...
const PBS_Specular: FC<PBS_SpecularInput> = (props: PBS_SpecularInput) => {
  const {
    id,
    persistentId,
    updateOrderId,
