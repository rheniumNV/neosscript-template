...
const ThresholdMaterial: FC<ThresholdMaterialInput> = (
  props: ThresholdMaterialInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.ThresholdMaterial"
      id={id}
    ...
    >
      ...
      <Member
        ...
        name="Threshold"
        content={Threshold} /* default: 0 */
      />
      <Member
        type={`FrooxEngine.Sync\`1[System.Single]`}
        name="Transition"
        content={Transition} /* default: 0 */
      />
      <Member
