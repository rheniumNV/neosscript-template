...
export interface LUT_MaterialInput {
  id?: string;
  persistentId?: string;
...
const LUT_Material: FC<LUT_MaterialInput> = (props: LUT_MaterialInput) => {
  const {
    id,
    persistentId,
    updateOrderId,
  ...
  return (
    ...
    >
      ...
      <Member
        ...
        name="LUT"
        content={LUT} /* default: ID0 */
      />
      <Member
        type={`FrooxEngine.AssetRef\`1[FrooxEngine.Texture3D]`}
        name="SecondaryLUT"
        content={SecondaryLUT} /* default: ID0 */
      />
      <Member
