...
export interface HSV_MaterialInput {
  id?: string;
  persistentId?: string;
  ...
  _shader?: member<any>;
  HSV_Offset?: member<[number, number, number]>;
  HSV_Multiply?: member<[number, number, number]>;
...
const HSV_Material: FC<HSV_MaterialInput> = (props: HSV_MaterialInput) => {
  const {
    id,
    persistentId,
    updateOrderId,
  ...
  return (
    ...
    >
      ...
      <Member
        ...
        name="HSV_Offset"
        content={HSV_Offset} /* default: [0; 0; 0] */
      />
      <Member
        type={`FrooxEngine.Sync\`1[BaseX.float3]`}
        name="HSV_Multiply"
        content={HSV_Multiply} /* default: [0; 0; 0] */
      />
      <Member
