...
export interface PosterizeMaterialInput {
  id?: string;
  persistentId?: string;
...
const PosterizeMaterial: FC<PosterizeMaterialInput> = (
  props: PosterizeMaterialInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PosterizeMaterial"
      id={id}
...
export default PosterizeMaterial;
