...
export interface PBS_TriplanarSpecularInput {
  id?: string;
  persistentId?: string;
...
const PBS_TriplanarSpecular: FC<PBS_TriplanarSpecularInput> = (
  props: PBS_TriplanarSpecularInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_TriplanarSpecular"
      id={id}
...
export default PBS_TriplanarSpecular;
