...
const PBS_MultiUV_Metallic: FC<PBS_MultiUV_MetallicInput> = (
  props: PBS_MultiUV_MetallicInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_MultiUV_Metallic"
      id={id}
    ...
    >
      ...
      <Member
        type={`FrooxEngine.Sync\`1[BaseX.float2]`}
        name="MetallicMapScale"
        content={MetallicMapScale} /* default: [0; 0] */
      />
      <Member
        type={`FrooxEngine.Sync\`1[BaseX.float2]`}
        name="MetallicMapOffset"
        content={MetallicMapOffset} /* default: [0; 0] */
      />
      <Member
        type={`FrooxEngine.Sync\`1[System.Int32]`}
        name="MetallicMapUV"
        content={MetallicMapUV} /* default: 0 */
      />
    </component>
  );
};

export default PBS_MultiUV_Metallic;
