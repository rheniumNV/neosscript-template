...
export interface PBS_DualSidedSpecularInput {
  id?: string;
  persistentId?: string;
...
const PBS_DualSidedSpecular: FC<PBS_DualSidedSpecularInput> = (
  props: PBS_DualSidedSpecularInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_DualSidedSpecular"
      id={id}
...
export default PBS_DualSidedSpecular;
