...
export interface PBS_IntersectSpecularInput {
  id?: string;
  persistentId?: string;
...
const PBS_IntersectSpecular: FC<PBS_IntersectSpecularInput> = (
  props: PBS_IntersectSpecularInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_IntersectSpecular"
      id={id}
...
export default PBS_IntersectSpecular;
