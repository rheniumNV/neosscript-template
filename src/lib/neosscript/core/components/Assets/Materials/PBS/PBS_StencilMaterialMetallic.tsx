...
const PBS_StencilMaterialMetallic: FC<PBS_StencilMaterialMetallicInput> = (
  props: PBS_StencilMaterialMetallicInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_StencilMaterialMetallic"
      id={id}
    ...
    >
      ...
      <Member
        ...
        name="__rectDummy"
        content={__rectDummy} /* default: [X=0; Y=0; W=0; H=0] */
      />
      <Member
        type={`FrooxEngine.Sync\`1[System.Boolean]`}
        name="__rectClipDummy"
        content={__rectClipDummy} /* default: False */
      />
      <Member
        type={`FrooxEngine.Sync\`1[System.Single]`}
        name="Metallic"
...
export default PBS_StencilMaterialMetallic;
