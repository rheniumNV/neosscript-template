...
export interface PBS_VertexColorSpecularInput {
  id?: string;
  persistentId?: string;
...
const PBS_VertexColorSpecular: FC<PBS_VertexColorSpecularInput> = (
  props: PBS_VertexColorSpecularInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_VertexColorSpecular"
      id={id}
    ...
    >
      ...
      />
      <Member
        type={`FrooxEngine.Sync\`1[FrooxEngine.PBS_VertexColorSpecular+ColorTarget]`}
...
export default PBS_VertexColorSpecular;
