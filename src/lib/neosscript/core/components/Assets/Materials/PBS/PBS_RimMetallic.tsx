...
export interface PBS_RimMetallicInput {
  id?: string;
  persistentId?: string;
...
const PBS_RimMetallic: FC<PBS_RimMetallicInput> = (
  props: PBS_RimMetallicInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_RimMetallic"
      id={id}
...
export default PBS_RimMetallic;
