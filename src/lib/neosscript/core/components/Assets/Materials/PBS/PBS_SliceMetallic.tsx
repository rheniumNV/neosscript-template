...
export interface PBS_SliceMetallicInput {
  id?: string;
  persistentId?: string;
...
const PBS_SliceMetallic: FC<PBS_SliceMetallicInput> = (
  props: PBS_SliceMetallicInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_SliceMetallic"
      id={id}
...
export default PBS_SliceMetallic;
