...
export interface PBS_ColorMaskSpecularInput {
  id?: string;
  persistentId?: string;
...
const PBS_ColorMaskSpecular: FC<PBS_ColorMaskSpecularInput> = (
  props: PBS_ColorMaskSpecularInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_ColorMaskSpecular"
      id={id}
...
export default PBS_ColorMaskSpecular;
