...
const PBS_DisplaceSpecular: FC<PBS_DisplaceSpecularInput> = (
  props: PBS_DisplaceSpecularInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_DisplaceSpecular"
      id={id}
...
export default PBS_DisplaceSpecular;
