...
export interface PBS_DistanceLerpSpecularInput {
  id?: string;
  persistentId?: string;
...
const PBS_DistanceLerpSpecular: FC<PBS_DistanceLerpSpecularInput> = (
  props: PBS_DistanceLerpSpecularInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_DistanceLerpSpecular"
      id={id}
...
export default PBS_DistanceLerpSpecular;
