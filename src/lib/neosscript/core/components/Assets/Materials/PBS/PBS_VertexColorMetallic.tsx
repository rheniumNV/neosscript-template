...
export interface PBS_VertexColorMetallicInput {
  id?: string;
  persistentId?: string;
  ...
  VertexColorTarget?: member<any>;
  _regular?: member<any>;
  _transparent?: member<any>;
  _transparentFront?: member<any>;
}

const PBS_VertexColorMetallic: FC<PBS_VertexColorMetallicInput> = (
  props: PBS_VertexColorMetallicInput
) => {
  const {
    id,
    persistentId,
  ...
  return (
    <component
      name="FrooxEngine.PBS_VertexColorMetallic"
      id={id}
    ...
    >
      ...
      />
      <Member
        type={`FrooxEngine.Sync\`1[FrooxEngine.PBS_VertexColorMetallic+ColorTarget]`}
        name="VertexColorTarget"
        content={VertexColorTarget} /* default: Albedo */
      />
      <Member
      ...
      <Member
        type={`FrooxEngine.AssetRef\`1[FrooxEngine.Shader]`}
        name="_transparentFront"
        content={_transparentFront} /* default: ID0 */
      />
    </component>
  );
};

export default PBS_VertexColorMetallic;
